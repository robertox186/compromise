...
// IbftPropose es el comando para consultar la instantánea
type IbftPropose struct {
	helper.Meta
}

//DefineFlags define las banderas de comando
...
//Synopsis implementa la interfaz cli.IbftPropose
func (p *IbftPropose) Synopsis() string {
	return p.GetHelperText()
}

// Extrayéndolo para que lo tengamos en una variable.
var (
	positive = "auth"
	negative = "drop"
)

// Ejecutar implementa la interfaz cli.IbftPropose
