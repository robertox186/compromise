...
//HBMessage es el mensaje de nivel superior. Contiene la época en la que el mensaje estaba
// creado y la carga útil real.
...
// HandleMessage procesará el ACSMessage dado para la época determinada.
...
// Iniciar intento de poner en marcha el motor de consenso.
// TODO (@anthdm): reconsiderar el cambio de API.
